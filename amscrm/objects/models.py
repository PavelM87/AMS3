...
class Object(models.Model):
	...
	objCountry = models.ForeignKey("Country", on_delete=models.CASCADE)
	objRegion = models.ForeignKey("Region", on_delete=models.CASCADE)
	objCity = models.ForeignKey("City", on_delete=models.CASCADE)
